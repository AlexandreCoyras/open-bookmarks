...
Open Bookmarks — application web PWA pour sauvegarder et organiser ses favoris, synchronisés entre tous les appareils.
...
- Toujours utiliser `bun` (jamais `npm`, `yarn`, `pnpm`, ou `node`)
- Validation des inputs API via TypeBox (`t`) côté Elysia
